...
add_recipe("Some Untraditional Stew", "http://www.catcancook.com/jamaican-beef-mango-stew/", ['potatos', 'garlic', 'mushrooms', 'tomatoes', 'mangoes' ])
add_recipe("Orange Juice", "https://www.youtube.com/watch?v=YkJXBV5FFsc", ['oranges'])
add_recipe("A Turkey Burger", "http://www.foodnetwork.com/topics/turkey-burger-recipes.html", ['turkey', 'onions', 'tomatoes', 'lettuce', 'bread'])
